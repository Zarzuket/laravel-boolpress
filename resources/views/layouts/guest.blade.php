    ...
    <div class="container">
      ...
      <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex">
          <a class="p-2 text-muted" href="{{route("posts.index")}}">Blog</a>
        </nav>
      </div>
      ...
      <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <div class="col-md-6 px-0">
          ...
          <p class="lead mb-0"><a href="{{route("single.post", $post["slug"])}}" class="text-white font-weight-bold">Continue reading..</a></p>
        </div>
      </div>
